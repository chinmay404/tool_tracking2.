...
class Product(models.Model):
    ...
    MaterialCode = models.PositiveIntegerField(null=True, default=0)
    material_UOM = models.CharField(max_length=10, null=True, default=None)
    category = models.CharField(max_length=100, null=True, blank=True , default="TOOLING")
...
class ProductIndexItem(models.Model):
    ...
    requested_weight = models.FloatField(default=0.0)
    recived_weight = models.FloatField(default=0.0)
...
class Master(models.Model):
    ...
    initial_weight = models.BooleanField(default=False)
